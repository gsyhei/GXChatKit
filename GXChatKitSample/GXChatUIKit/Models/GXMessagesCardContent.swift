...
public class GXMessagesCardContent: GXMessagesContentDelegate {
    ...
    /// 名片联系人对象（用户/群）
    public var contact: GXMessagesContactDelegate
    /// 名片类型名
    public var cardTypeName: String
    /// 头像
    public var cardAvatar: GXMessagesAvatar

    public required init(contact: GXMessagesContactDelegate, avatar: GXMessagesAvatar? = nil) {
