...
public class GXMessagesAudioContent: GXMessagesContentDelegate {
    ...
    public required init(audioURL: URL?, duration: TimeInterval, tracks: [Float]? = nil) {
        self.audioURL = audioURL
        self.duration = duration
        self.tracks = tracks
    }
    
    public required init(fileURL: URL?, duration: TimeInterval, tracks: [Float]? = nil) {
